"""Alembic environment: reuses the application's DATABASE_URL from settings."""
...
# Make the application packages importable (backend/src on sys.path)
...
# Phase 2 ORM models are now visible to Alembic autogenerate.
